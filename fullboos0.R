...
n <- nrow(df)
B <- 1000
estimators0 <- matrix(NA_real_, ncol = 4, nrow = B,
...
for (i in 1:B) {
  ...
  estimators0[i, ] <- get_estimators_fast(df_sample, 0)
}

write.csv(estimators0, "/home/mcolonva/Boostrap/fullBoostrap0.csv", row.names = FALSE)
